import smtplib
from app.modules.popup.repository.repository import create_email_message
...
async def send_email(form_data: ContactForm):
    try:
        ...
        db = mongo_db_manager.get_database("popup")
        await db.popups.insert_one(jsonable_encoder(form_data))
